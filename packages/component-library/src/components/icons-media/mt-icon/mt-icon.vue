...
watch(
  ...
  () => {
    import(
      `./../../../../node_modules/@heyadmin-ag/meteor-icon-kit/icons/${iconInformation.value.mode}/${iconInformation.value.name}.svg`
    )
      .then((data) => {
        if (data.default) {
...
<style lang="scss">
@import "node_modules/@heyadmin-ag/meteor-icon-kit/icons/meteor-icon-kit.scss";
